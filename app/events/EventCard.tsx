...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
    return (
        <div >
            <div className="bg-[#101010] relative group cursor-pointer hover:ring-[1px] hover:scale-[105%] transition-transform duration-500  ring-[0.5px] ring-[#808080] rounded-[20px] w-full max-w-[500px] h-[520px]">
