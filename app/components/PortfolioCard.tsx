...
const PortfolioCard: React.FC<PortfolioCardProps> = ({ text, lang1, lang2, lang3, lang4, lang5, lang6, text2, onClick }) => {
    return (
        <div className="bg-[#373435] hover:scale-[105%] transition-transform duration-500 text-[15.27px] sm:h-[350px] ring-[1px] ring-[#373435]  sm:w-[500px] cursor-pointer  flex flex-col sm:flex-row sm:pl-[10px]  rounded-[20px]" onClick={onClick}>
            ...
            <p className="text-[14px] leading-[19px] px-[10px]">{text2}</p>
                ...
                <div className="sm:w-[38.2%] px-[10px] flex sm:hidden items-center justify-center">
                    <div className="grid grid-cols-3 gap-[10px] pt-[15px] pb-[10px] flex-col">
