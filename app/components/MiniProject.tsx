...
const MiniProject: React.FC<MiniProjectProps> = ({ title, description, imageUrl, githubUrl, demoUrl, category }) => {
  return (
    <div className="hover:scale-[108%] relative  transition-transform duration-500 w-full max-w-[190px] sm:max-w-[220px] rounded-[15px] bg-black ring-[#808080] ring-[1px] cursor-pointer h-[300px] sm:h-[320px]">
