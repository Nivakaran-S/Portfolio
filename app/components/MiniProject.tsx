...
const MiniProject: React.FC<MiniProjectProps> = ({ title, description, imageUrl, githubUrl, demoUrl, category }) => {
  return (
    <div className="hover:scale-[108%] relative  transition-transform duration-500 w-full max-w-[300px] sm:max-w-[220px] rounded-[15px] bg-black ring-[#808080] ring-[1px] cursor-pointer h-[300px] sm:h-[320px]">
      <div className="flex items-center justify-center bg-[#373435] rounded-[15px] h-[100%]">
        ...
        />
        <div className="flex flex-col ring-[0.8px] ring-[#808080] absolute h-[230px] sm:h-[250px] rounded-[10px] sm:rounded-[10px] bottom-0  bg-[#1D1D1D] w-[95%] sm:w-[220px] px-[10px] justify-between py-[10px]">
