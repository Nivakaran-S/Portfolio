...
const BlogCard: React.FC<BlogCardProps> = ({ text, image, text1, onClick }) => {
    return (
        <div className="bg-[#4b4b4d] relative hover:scale-[107%] tran sition-transform duration-500 ring-[0.5px] ring-[#4b4b4d] text-[15.27px] cursor-pointer h-[270px] sm:h-[360px] w-[180px] sm:w-[230px] flex flex-col rounded-[10px] sm:rounded-[20px]" onClick={onClick}>
