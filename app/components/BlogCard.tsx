...
const BlogCard: React.FC<BlogCardProps> = ({ text, text1, onClick }) => {
    return (
        <div className="bg-[#4b4b4d] hover:scale-[107%] transition-transform duration-500 ring-[0.5px] ring-[#4b4b4d] text-[15.27px] cursor-pointer h-[280px] sm:h-[340px] w-[190px] flex flex-col rounded-[10px] sm:rounded-[20px]" onClick={onClick}>
